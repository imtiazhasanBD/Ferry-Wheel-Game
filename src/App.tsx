          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute -left-8 -right-8 flex justify-between">
              ...
              <div className="flex flex-col items-center w-10">
                <div className="bg-yellow-400 rounded-full p-1 shadow-md border-2 border-orange-500">
                  <span className="text-3xl">🍕</span>
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md -mt-2 shadow absolute">
                  Pizza
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md -bottom-3 -left-1 shadow absolute">
                  Total 0
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md mt-4 ml-12 shadow absolute">
                  2.45x
                </div>
              </div>
              {/* Pizza */}
              <div className="flex flex-col items-center w-10">
                <div className="bg-green-400 rounded-full p-1 shadow-md border-2 border-green-600">
                  <span className="text-3xl">🥗</span>
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md -mt-2 shadow absolute">
                  Salad
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md -bottom-3 -right-1 shadow absolute">
                  Total 0
                </div>
                <div className="bg-[#0864b4] text-white text-[8px] font-bold p-1 rounded-md mt-4 mr-14 shadow absolute">
                  1.45x
                </div>
              </div>
            ...
            >
              <div className="mx-auto w-[350px] max-w-[350px] rounded-t-2xl bg-white/10 text-white shadow-2xl border-t border-white/15 p-4 backdrop-blur-xl">
                <div className="flex items-center justify-between">
                  ...
                  <button className="text-[22px]" onClick={() => setSettingsOpen(false)}>
                    ✕
                  </button>
                </div>
