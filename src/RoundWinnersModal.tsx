...
/* =========================================================
   RoundWinnersModal — BOTTOM DRAWER version
   ========================================================= */
export default function RoundWinnersModal({
  open,
  onClose,
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            {/* Grab handle */}
            <div className="mx-auto mt-2 mb-1 h-1.5 w-10 rounded-full bg-white/35" />
            ...
            {/* Ribbon — keep your look, still floats above top edge */}
            <div className="absolute -top-8 left-1/2 -translate-x-1/2">
              <motion.div
                initial={{ y: -16, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
            ...
            {/* Inner Content */}
            <div
              className="mt-10 mx-2 mb-2 rounded-[18px] p-[12px]"
              style={{
                background:
                  "linear-gradient(180deg, rgba(255,255,255,.12) 0%, rgba(255,255,255,.06) 100%)",
                border: "1px solid rgba(35,121,201,.35)",
            ...
            >
              ...
              <div className="flex justify-between gap-2 mb-3">
                ...
                {/* Two glass rows (win/bet) styled to match */}
                <div className="space-y-1">
                  <GlassRow label="This Round Win" value={myWin} />
                  <GlassRow label="This Round Bet" value={myBet} />
                </div>
              </div>
...
function GlassRow({ label, value }: { label: string; value: number }) {
  return (
    <div
      className="flex items-center justify-between rounded-[12px] px-3 py-[6px] text-[13px]"
      style={{
